	...
	foreach (XElement e in result)
	{
		...
		select c
			...
			foreach (var routine in routines)
			{
				...
				{
//					var routineParse = XElement.Parse(routine.ToString());
//					using (StringWriter sw = new StringWriter())
//					{
//						routineParse.Save(sw);
//						Console.WriteLine(sw.ToString());
//					}
					//routine.Dump();
					//using(FileStream stream = File.ReadAllText(routine))
					XmlSerializer serializer = new XmlSerializer(typeof(Routine));
					
					using (TextWriter textWriter = new StringWriter())
					{
						routine.Save(textWriter,SaveOptions.DisableFormatting);
						//Console.WriteLine(textWriter.ToString());
//						using (XmlWriter xmlWriter = XmlWriter.Create(textWriter))
//						{
//							routine.WriteTo(xmlWriter);
//							//xmlWriter.Dump();
//						}
						var obj = new Routine();
//						
